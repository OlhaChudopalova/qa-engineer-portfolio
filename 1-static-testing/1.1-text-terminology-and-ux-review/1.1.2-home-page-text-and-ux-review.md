...
- Consistency of text and terminology across the page
- Clarity, readability, and cognitive understandability of content
- Visual coherence and user interaction patterns
- Improvement of CTAs and informational blocks for better UX
...
- All **Quick Fixes** have been applied on the Home page.  
- Screenshots for each applied fix are embedded directly in the document below.
...
> EN:  How it works / `Category` / Price List
>
> &nbsp;
...
> EN: How it works / `Categories` / Price List 
>
> &nbsp;
...
The screenshots referenced in this document are also stored separately in the following folders:

- **Quick Fixes**: [screenshots_quick](./screenshots_quick/)
- **Long-term UX Improvements**: [screenshots_long](./screenshots_long/)
- **Implemented Quick Fixes**: [screenshots_fix](./screenshots_fix/)
